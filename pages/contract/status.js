...
*/
const _STATUS_LIST = new Map([[1, 1], [2, 2], [3, 2], [4, 3], [5, 4], [6, 5], [7, 5]])

/* 
正常流程UI
ui_status  1提交需求 2托管赏金 3凌客工作 4验收付款 5评价
*/
const _UI_STATUS_LIST = new Map([[1, '提交需求'], [2, '托管赏金'], [3, '凌客工作'], [4, '验收付款'], [5, '评价']])
...
/* 
异常流程UI
ui_status  1提交需求 2托管赏金 6已退款 7未退款 8已关闭 
*/
const ERROR_UI_STATUS_LIST = new Map([[1, '提交需求'], [2, '托管赏金'], [6, '已退款'], [7, '未退款'], [8, '已关闭']])
