...
export default {
  ...
  mounted() {
    if (!this.$route.query.id) {
      ...
      if (this.$route.query.id) {
        this.init();
        if (this.$route.query.id == "49") {
          this.indexX = this.$route.query.id;
          this.id = this.$route.query.id;
          this.Oid = "136";
           this.helpCen();
        }
        if (this.$route.query.id == "35"&&!this.$route.query.Oid) {
          this.indexX = this.$route.query.id;
          this.id = this.$route.query.id;
          this.Oid = "12";
           this.helpCen();
        } else if(this.$route.query.id&&this.$route.query.Oid) {
           this.indexX = this.$route.query.id;
             this.id = this.$route.query.id;
           this.Oid=this.$route.query.Oid
        }else if(this.$route.query.id=='32'&&!this.$route.query.Oid){
            this.indexX = this.$route.query.id;
          this.id = this.$route.query.id;
           this.helpCen();
        }
