    ...
    <div class="service_details">
      ...
      <div class="service_Nav">
        <div class="serviced">
          <ul class="nav_classify" v-if="this.$route.params.id || this.$route.query.cate_code">
            ...
            <li>
              ...
              <div class="Submenu" v-else>暂无数据</div>
              <svg class="icon" aria-hidden="true">
                <use xlink:href="#icon-xiangyoudianji" />
              </svg>
            </li>
        ...
        <div class="nav_list user_select">
          ...
          <div :class="['navList Territory', showAlltory?'colordisplay':'']">
            <p>{{territory.name}}:</p>
            <div class="navName">
              <div class="priceAll navName_top navNameTerritory">
                <div class="cany">
          ...
          <div class="navList Territory region">
            <p>{{region.name}}:</p>
            <div class="navName">
              <div class="priceAll navName_top navNameTerritory">
                <div class="add">
      ...
      <div class="shopList">
        ...
        <div class="shopLis_right">
          ...
          <div class="shopLis_right_cont">
            <div class="shopLi_ul" v-if="shopLisRightCont.length >0">
              ...
              >
                ...
                >
                  <img
                    src="~assets/img/userDataImg.png"
                    v-lazy="Cont.img +'?x-oss-process=image/resize,m_fill,h_172,w_224'"
                    :title="Cont.name"
                    :alt="Cont.name"
                  />
                </nuxt-link>
            ...
            <div class="dataNonea searNodata" v-else>
              <img class="mr_10" width="90" height="115" src="../../assets/img/pintouge.png" alt />
              <span>抱歉，没有找到“<p>{{this.$route.query.keywords}}</p>”对应的服务，请试试其他关键词试试</span> 
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="advert_data" v-if="advertising.length > 0">
            ...
            >
              ...
              <div class="liatM">
                ...
                <span>￥{{parseInt(item.price)}}/{{item.unit_name}}</span>
              </div>
            </nuxt-link>
          </div>
          <div class="dataNone" v-else>
...
export default {
  ...
  head() {
    return {
      // title: `${this.SubmenuList.cate_name || ""}${'-'+ this.T_rec  || ""}${'-'+ this.S_rec  || ""} - 凌天众媒`,
      title: `${this.keywords} - 凌天众媒网`,
      meta: [
        {
          hid: "keywords",
          name: "keywords",
          content: `凌天众媒网${this.keyWord}`
        },
        {
          hid: "description",
          name: "description",
          content: `凌天众媒网（zhongmei66.com）${this.keywords}频道, 一站式全媒界大型媒体电商平台`
        }
      ]
    };
  },
  ...
  created() {
    ...
    const { keywords, _sel, page } = this.$route.query;
  ...
  mounted() {
    this.dataEvent();
    if (this.params.page > this.lastPageD) {
  ...
  methods: {
    dataEvent() {
      ...
      dataEventTrack({
        ...
        kv: {
          router: `/category?keywords=${this.$route.query.keywords}&_sel=1&page=${this.$route.query.page}`,
