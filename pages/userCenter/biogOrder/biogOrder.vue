        ...
        <div class="mayOrder">
          ...
          <div class="myDeposit_bot">
            ...
            <table cellspacing cellpadding class="table" v-if="caseList != null">
              ...
              <tbody class="none" v-if="caseList.length == 0">
...
export default {
  ...
  methods: {
    ...
    initOrder() {
      ...
      this.isLoading = true;
      caseBiog(type, this.page, keyword, created, "2")
        .then(res => {
          if (res.data.code == 200) {
            const {
              data = [],
    ...
    journalClick(item) {
      var { href } = this.$router.resolve({
        path: "/userCenter/biogOrder/biogOrder",
        query: {
          type: 1,
